...
function renderZoneSummary(){
  ...
  $('#method-explanation').innerHTML=isDbscan
    ? '<strong>DBSCAN menandai pola pemeriksaan yang tidak biasa.</strong><p>Peta membantu melihat lokasi fasilitas yang perlu ditinjau lebih lanjut.</p>'
    : '<strong>K-Means menunjukkan kelompok kerentanan fasyankes.</strong><p>Peta membantu melihat kelompok fasilitas dan wilayah yang perlu ditinjau lebih lanjut.</p>';
}
...
function methodology(){
  ...
  if(!dialog){
    ...
    dialog.innerHTML=`<button class="dialog-close" id="intro-close" aria-label="Tutup pengantar">×</button>
      ...
      <section class="intro-conclusion"><p>K-Means dan DBSCAN digunakan bersama untuk mengubah data pelaporan menjadi informasi yang lebih mudah dipahami.</p><p><strong>K-Means menunjukkan kelompok kerentanan fasyankes</strong>, sedangkan <strong>DBSCAN menandai pola pemeriksaan yang tidak biasa</strong>.</p><p>Hasil keduanya ditampilkan pada peta untuk membantu menentukan fasilitas dan wilayah yang perlu ditinjau lebih lanjut.</p></section>
