  ...
  if(!dialog){
    ...
    dialog.innerHTML=`<button class="dialog-close" id="intro-close" aria-label="Tutup pengantar">×</button>
      ...
      <div class="intro-algorithms">
        <article class="intro-algorithm"><span class="intro-number">01 · MENGELOMPOKKAN YANG MIRIP</span><h3>K-Means</h3><p><strong>Mengelompokkan fasyankes yang memiliki data pemeriksaan serupa.</strong> Contoh data yang dapat dibandingkan dalam rancangan ini adalah jumlah sampel yang diperiksa dan nilai TSH maksimum, yaitu nilai TSH tertinggi pada hasil pemeriksaan di suatu fasyankes.</p><p class="intro-role"><strong>Contoh sederhana:</strong> Puskesmas A dan B sama-sama memeriksa sekitar 50 sampel dan memiliki nilai TSH maksimum yang mirip. Keduanya dapat masuk kelompok yang sama. Fasyankes dengan data yang jauh berbeda dapat masuk kelompok lain.</p><div class="intro-chips"><span>Rendah</span><span>Sedang</span><span>Tinggi</span></div><p class="intro-role">Dashboard menampilkan tiga kelompok risiko. Sebutan rendah, sedang, dan tinggi perlu ditentukan peneliti setelah memeriksa hasilnya. Banyaknya sampel saja tidak berarti risikonya tinggi.</p></article>
        <article class="intro-algorithm"><span class="intro-number">02 · MENCARI YANG BERBEDA</span><h3>DBSCAN</h3><p><strong>Mencari fasyankes yang tidak memiliki cukup banyak kemiripan dengan fasyankes lain.</strong> Data yang saling berdekatan dan cukup banyak membentuk kelompok. Data yang tidak tergabung ditandai sebagai <em>outlier</em>, atau data yang perlu ditinjau lebih lanjut.</p><p class="intro-role"><strong>Contoh sederhana:</strong> Banyak fasyankes memiliki jumlah sampel dan nilai TSH maksimum yang mirip. Ada satu fasyankes dengan nilai yang sangat berbeda dan hanya sedikit fasilitas yang menyerupainya. Fasilitas ini dapat ditandai sebagai outlier, tergantung pengaturan metode.</p><div class="intro-chips dbscan-chips"><span>Normal</span><span>Outlier</span></div><p class="intro-role">Jika lokasi ikut dianalisis, jarak antarfasyankes juga diperhitungkan. “Normal” di sini berarti tidak ditandai sebagai outlier, bukan berarti semua hasil pemeriksaannya normal secara medis.</p></article>
      </div>
      <section class="intro-why"><h3>Mengapa dipakai bersama?</h3><p><strong>K-Means membantu melihat kelompok fasyankes yang serupa. DBSCAN membantu menemukan fasyankes yang berbeda dari kebanyakan fasilitas lain.</strong> Dalam penelitian ini, keduanya dipakai bersama agar peneliti bisa melihat gambaran umum sekaligus memilih data yang perlu diperiksa lebih lanjut.</p><p>Sebuah fasilitas bisa masuk kelompok risiko sedang, tetapi tetap ditandai sebagai outlier. Jadi, <strong>outlier tidak otomatis berarti risiko tinggi</strong>. Peneliti perlu memeriksa data dan kondisi fasilitas untuk memahami alasannya.</p></section>
