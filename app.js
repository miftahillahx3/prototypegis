...
function methodology(){showDialog('<span class="eyebrow">TENTANG PROTOTIPE</span><h2>Hybrid spatial clustering</h2><p>Prototipe interaktif untuk penelitian pemetaan kerentanan neonatal pada program Skrining Bayi Baru Lahir di Jawa Barat.</p><div class="detail-box"><strong>01 · Zonasi K-Means</strong><p>Menampilkan tiga kelompok kerentanan: rendah, sedang, dan tinggi. Pada versi ini, label klaster sudah ditentukan untuk demonstrasi, bukan dihitung dari data pasien.</p><strong>02 · Anomali DBSCAN</strong><p>Menampilkan fasilitas normal dan outlier. Label anomali juga merupakan simulasi, bukan hasil eksekusi algoritma.</p></div><p>812 fasilitas sintetis digunakan untuk menguji interaksi. Peta dasar menggunakan geografi nyata OpenStreetMap. Titik fasilitas merupakan koordinat simulasi di sekitar kota terkait, bukan alamat sebenarnya. Silhouette 0,5006 merupakan nilai referensi dari mockup. Periode menggunakan subset demonstrasi, dan grafik tren adalah skenario ilustratif.</p>')}
